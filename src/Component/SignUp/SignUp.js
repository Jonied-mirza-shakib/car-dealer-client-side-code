            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12">
                        <div style={{ backgroundColor: 'aliceblue', padding: '30px', marginBottom: '50px', borderRadius: '20px' }} className='w-50 mx-auto'>
                            <Form onSubmit={handleCreateUser}>
                                ...
                                <Button className='w-100' variant="primary" type="submit" required>
                                    Submit
                                </Button>
                            </Form>
